...
public class TestStripePaymentPluginApi extends TestBase {
    ...
    public void testSEPADebitSourceAndChargesAPI() throws PaymentPluginApiException, StripeException, PaymentApiException {
        ...
        sourceParams.put("sepa_debit", ImmutableMap.of("iban","DE89370400440532013000"));
        ...
        final Source source = Source.create(sourceParams, options);
        ...
        stripePaymentPluginApi.addPaymentMethod(kbAccountId,
                                                ...
                                                true,
                                                ImmutableList.of(new PluginProperty("source", source.getId(), false)),
                                                context);
        ...
        verifyPaymentTransactionInfoPlugin(payment1, purchaseTransaction1, purchaseInfoPlugin1, PaymentPluginStatus.PENDING);

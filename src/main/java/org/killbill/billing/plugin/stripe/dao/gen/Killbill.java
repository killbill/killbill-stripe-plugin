...
public class Killbill extends SchemaImpl {
    ...
    private static final long serialVersionUID = 1234594759;
     ...
     */
    public final StripeHppRequests STRIPE_HPP_REQUESTS = org.killbill.billing.plugin.stripe.dao.gen.tables.StripeHppRequests.STRIPE_HPP_REQUESTS;

    /**
     * The table <code>killbill.stripe_payment_methods</code>.
     */
    public final StripePaymentMethods STRIPE_PAYMENT_METHODS = org.killbill.billing.plugin.stripe.dao.gen.tables.StripePaymentMethods.STRIPE_PAYMENT_METHODS;

    /**
     * The table <code>killbill.stripe_responses</code>.
     */
    public final StripeResponses STRIPE_RESPONSES = org.killbill.billing.plugin.stripe.dao.gen.tables.StripeResponses.STRIPE_RESPONSES;
